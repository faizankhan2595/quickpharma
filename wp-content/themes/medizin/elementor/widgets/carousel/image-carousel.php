...
class Widget_Image_Carousel extends Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Carousel', 'medizin' );
	}
	...
	protected function print_slides( array $settings ) {
		...
		$image_size = \Medizin_Image::elementor_parse_image_size( $settings, '1170x670' );
	...
	private function add_image_style_section() {
		...
		$this->add_responsive_control( 'image_height', [
			...
			'description' => esc_html__( 'Controls the height of images. Use for slider per view auto.', 'medizin' ),
