...
class Widget_Portfolio_Carousel extends Posts_Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolio Carousel', 'medizin' );
	}
	...
	private function add_layout_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'medizin-portfolio-carousel-',
		] );
		...
		<div class="swiper-slide">
			<div class="post-wrapper medizin-box">
				...
				<?php if ( '02' === $settings['style'] ) : ?>
					<a href="<?php \Medizin_Portfolio::instance()->the_permalink(); ?>"
					   class="post-permalink link-secret">
						<div class="post-thumbnail medizin-image">
				...
				<?php else: ?>
					...
					<div class="post-info">
						<h3 class="post-title">
							<a href="<?php \Medizin_Portfolio::instance()->the_permalink(); ?>"><?php the_title(); ?></a>
						</h3>

						<?php \Medizin_Portfolio::instance()->the_categories(); ?>
					</div>
				<?php endif; ?>
