...
class Widget_Modern_Carousel extends Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Carousel', 'medizin' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'medizin-modern-carousel' );
		?>
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'medizin-modern-carousel-style-',
		...
		$repeater->add_control( 'tags', [
			...
			'type'        => Controls_Manager::TEXTAREA,
			'placeholder' => esc_html__( 'One tag per line', 'medizin' ),
		] );
	...
	private function add_style_section() {
		...
		$this->add_control( 'description_color', [
			'label'     => esc_html__( 'Description Color', 'medizin' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
	...
	protected function print_slides( array $settings ) {
		...
		foreach ( $settings['slides'] as $slide ) :
			...
			$this->add_render_attribute( $box_key, 'class', 'medizin-box slide-wrapper' );
			...
			<div <?php $this->print_attributes_string( $item_key ); ?>>
				...
				<?php if ( '02' === $settings['style'] ): ?>
					<div class="slide-image medizin-image">
