...
class Widget_Flip_Box extends Base {
	...
	public function get_title() {
		return esc_html__( 'Advanced Flip Box', 'medizin' );
	}
	...
	public function get_script_depends() {
		return [ 'medizin-widget-flip-box' ];
	}
	...
	private function add_front_side_content_section() {
		$this->start_controls_section( 'content_front_side_section', [
			'label' => esc_html__( 'Front', 'medizin' ),
		] );

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => esc_html__( 'Content', 'medizin' ) ] );

		$this->add_control( 'graphic_element_a', [
			'label'       => esc_html__( 'Graphic Element', 'medizin' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => false,
			'options'     => [
				'none'  => [
					'title' => esc_html__( 'None', 'medizin' ),
					'icon'  => 'eicon-ban',
				],
				'image' => [
					'title' => esc_html__( 'Image', 'medizin' ),
					'icon'  => 'fa fa-picture-o',
				],
				'icon'  => [
					'title' => esc_html__( 'Icon', 'medizin' ),
					'icon'  => 'eicon-star',
				],
			],
			'default'     => 'icon',
		...
		$this->add_control( 'image_a', [
			'label'     => esc_html__( 'Choose Image', 'medizin' ),
		...
		$this->add_control( 'title_text_a', [
			'label'       => esc_html__( 'Title & Description', 'medizin' ),
		...
		$this->add_control( 'description_text_a', [
			...
			'default'     => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'medizin' ),
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => esc_html__( 'Background', 'medizin' ) ] );
	...
	private function add_back_side_content_section() {
		$this->start_controls_section( 'content_back_side_section', [
			'label' => esc_html__( 'Back', 'medizin' ),
		] );

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => esc_html__( 'Content', 'medizin' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => esc_html__( 'Background', 'medizin' ) ] );
	...
	private function add_box_settings_section() {
		$this->start_controls_section( 'section_box_settings', [
			'label' => esc_html__( 'Settings', 'medizin' ),
		] );

		$this->add_responsive_control( 'min_height', [
			'label'      => esc_html__( 'Min Height', 'medizin' ),
			...
			'size_units' => [ 'px' ],
			'selectors'  => [
				'{{WRAPPER}} .medizin-flip-box' => 'min-height: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'flip_effect', [
			'label'        => esc_html__( 'Flip Effect', 'medizin' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'flip',
			'options'      => [
				'flip'     => 'Flip',
			...
			'prefix_class' => 'medizin-flip-box--effect-',
		] );

		$this->add_control( 'flip_direction', [
			'label'        => esc_html__( 'Flip Direction', 'medizin' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'up',
			'options'      => [
				'left'  => esc_html__( 'Left', 'medizin' ),
				'right' => esc_html__( 'Right', 'medizin' ),
				'up'    => esc_html__( 'Up', 'medizin' ),
				'down'  => esc_html__( 'Down', 'medizin' ),
			],
			'condition'    => [
				'flip_effect!' => [
					'fade',
			...
			'prefix_class' => 'medizin-flip-box--direction-',
		] );

		$this->add_control( 'flip_3d', [
			'label'        => esc_html__( '3D Depth', 'medizin' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => esc_html__( 'On', 'medizin' ),
			'label_off'    => esc_html__( 'Off', 'medizin' ),
			'return_value' => 'medizin-flip-box--3d',
			'default'      => '',
			'prefix_class' => '',
			'condition'    => [
				'flip_effect' => 'flip',
	...
	private function add_front_side_box_style_section() {
		$this->start_controls_section( 'box_style_front_side_section', [
			'label' => esc_html__( 'Front - Box', 'medizin' ),
		...
		$this->add_control( 'alignment_a', [
			...
			'options'     => [
				...
				'center' => [
					'title' => esc_html__( 'Center', 'medizin' ),
		...
		$this->add_control( 'vertical_position_a', [
			'label'                => esc_html__( 'Vertical Position', 'medizin' ),
			'type'                 => Controls_Manager::CHOOSE,
			'label_block'          => false,
			'options'              => [
				'top'    => [
	...
	private function add_front_side_image_style_section() {
		$this->start_controls_section( 'image_style_front_side_section', [
			'label'     => esc_html__( 'Front - Image', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_a' => 'image',
			],
	...
	private function add_front_side_icon_style_section() {
		$this->start_controls_section( 'icon_style_front_side_section', [
			'label'     => esc_html__( 'Front - Icon', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_a' => 'icon',
			],
		...
		$this->add_control( 'icon_spacing_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .medizin-icon-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_responsive_control( 'icon_size_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .medizin-icon-view, {{WRAPPER}} .front-side .medizin-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'icon_rotate_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .medizin-icon' => 'transform: rotate({{SIZE}}{{UNIT}});',
			],
		] );
	...
	private function add_front_side_heading_style_section() {
		$this->start_controls_section( 'heading_style_front_side_section', [
			'label'     => esc_html__( 'Front - Heading', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'title_text_a!' => '',
			],
	...
	private function add_front_side_description_style_section() {
		$this->start_controls_section( 'description_style_front_side_section', [
			'label'     => esc_html__( 'Front - Description', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'description_text_a!' => '',
			],
	...
	private function add_back_side_box_style_section() {
		$this->start_controls_section( 'box_style_back_side_section', [
			'label' => esc_html__( 'Back - Box', 'medizin' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
	...
	private function add_back_side_image_style_section() {
		$this->start_controls_section( 'image_style_back_side_section', [
			'label'     => esc_html__( 'Back - Image', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_b' => 'image',
			],
	...
	private function add_back_side_icon_style_section() {
		$this->start_controls_section( 'icon_style_back_side_section', [
			'label'     => esc_html__( 'Back - Icon', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_b' => 'icon',
			],
		...
		$this->add_control( 'icon_spacing_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .medizin-icon-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_responsive_control( 'icon_size_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .medizin-icon-view, {{WRAPPER}} .back-side .medizin-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'icon_rotate_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .medizin-icon' => 'transform: rotate({{SIZE}}{{UNIT}});',
			],
		] );
	...
	private function add_back_side_heading_style_section() {
		$this->start_controls_section( 'heading_style_back_side_section', [
			'label'     => esc_html__( 'Back - Heading', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'title_text_b!' => '',
			],
	...
	private function add_back_side_description_style_section() {
		$this->start_controls_section( 'description_style_back_side_section', [
			'label'     => esc_html__( 'Back - Description', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'description_text_b!' => '',
			],
	...
	private function print_heading( array $settings, $side = 'a' ) {
		...
		<div class="heading-wrap">
			<h3 class="heading">
				<?php echo wp_kses( $settings["title_text_{$side}"], 'medizin-default' ); ?>
			</h3>
		</div>
		<?php
	}
	...
	private function print_description( array $settings, $side = 'a' ) {
		...
		<div class="description-wrap">
			<div class="description">
				<?php echo wp_kses( $settings["description_text_{$side}"], 'medizin-default' ); ?>
			</div>
		</div>
		<?php
	}
				...
				<div class="layer-inner">
					<div class="layer-content">
						...
						<#  } else if ( 'icon' === settings.graphic_element_a ) { #>
							<#
							view.addRenderAttribute( 'iconA', 'class', 'medizin-icon icon' );

							if ( 'svg' === settings.icon_a.library ) {
								view.addRenderAttribute( 'iconA', 'class', 'medizin-svg-icon' );
							}

							if ( 'gradient' === settings.icon_a_color_type ) {
								view.addRenderAttribute( 'iconA', 'class', 'medizin-gradient-icon' );
							} else {
								view.addRenderAttribute( 'iconA', 'class', 'medizin-solid-icon' );
							}
				...
				<div class="layer-inner">
					<div class="layer-content">
						...
						<#  } else if ( 'icon' === settings.graphic_element_b ) { #>
							<#
							view.addRenderAttribute( 'iconB', 'class', 'medizin-icon icon' );

							if ( 'svg' === settings.icon_b.library ) {
								view.addRenderAttribute( 'iconB', 'class', 'medizin-svg-icon' );
							}

							if ( 'gradient' === settings.icon_b_color_type ) {
								view.addRenderAttribute( 'iconB', 'class', 'medizin-gradient-icon' );
							} else {
								view.addRenderAttribute( 'iconB', 'class', 'medizin-solid-icon' );
							}
