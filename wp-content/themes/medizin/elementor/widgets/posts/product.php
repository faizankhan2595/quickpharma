...
class Widget_Product extends Posts_Base {
	...
	public function get_title() {
		return esc_html__( 'Product', 'medizin' );
	}
	...
	private function add_grid_options_section() {
		...
		$this->add_responsive_control( 'grid_column_gutter', [
			'label'     => esc_html__( 'Column Gutter', 'medizin' ),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
		...
		$this->add_responsive_control( 'grid_row_gutter', [
			'label'     => esc_html__( 'Row Gutter', 'medizin' ),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
	...
	private function add_caption_style_section() {
		...
		$this->add_control( 'caption_title_heading', [
			'label'     => esc_html__( 'Product Name', 'medizin' ),
		...
		$this->add_control( 'caption_price_heading', [
			'label'     => esc_html__( 'Product Price', 'medizin' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->start_controls_tab( 'caption_regular_price_tab', [
			'label' => esc_html__( 'Regular', 'medizin' ),
		] );
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'medizin-grid-wrapper medizin-product style-grid-01' );
