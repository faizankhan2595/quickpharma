...
class Widget_Image_Layers extends Base {
	...
	public function get_title() {
		return esc_html__( 'Image Layers', 'medizin' );
	}
	...
	private function add_artboard_section() {
		$this->start_controls_section( 'artboard_section', [
			'label' => esc_html__( 'Artboard', 'medizin' ),
		] );
	...
	private function add_layers_section() {
		$this->start_controls_section( 'layers_section', [
			'label' => esc_html__( 'Layers', 'medizin' ),
		] );

		$repeater = new Repeater();

		$repeater->add_control( 'static', [
			'label' => esc_html__( 'Static Layer', 'medizin' ),
		...
		$repeater->add_control( 'loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__( 'Rotate', 'medizin' ),
				'move-horizontal' => esc_html__( 'Move - Horizontal', 'medizin' ),
				'move-vertical'   => esc_html__( 'Move - Vertical', 'medizin' ),
			],
			'default' => '',
		] );
