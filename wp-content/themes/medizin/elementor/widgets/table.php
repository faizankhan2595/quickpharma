...
class Widget_Table extends Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'medizin' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'table_head_section', [
			'label' => esc_html__( 'Table Header', 'medizin' ),
		] );
		...
		$table_header->add_control( 'action', [
			...
			'description' => esc_html__( 'You have started a new row. Please add new cells in your row by clicking Add Item button below.', 'medizin' ),
			'type'        => Controls_Manager::SELECT,
			'default'     => 'Cell',
			'options'     => [
				'Row'  => esc_html__( 'Start New Row', 'medizin' ),
				'Cell' => esc_html__( 'Add New Cell', 'medizin' ),
			],
		] );
		...
		$table_header->add_control( 'text', [
			...
			'default'   => esc_html__( 'Sample', 'medizin' ),
			'condition' => [
				'action' => 'Cell',
			],
		] );
		...
		$this->start_controls_section( 'table_body_section', [
			'label' => esc_html__( 'Table Content', 'medizin' ),
		] );
