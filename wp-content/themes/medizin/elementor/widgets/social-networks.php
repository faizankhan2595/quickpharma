...
class Widget_Social_Networks extends Base {
	...
	public function get_title() {
		return esc_html__( 'Social Networks', 'medizin' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'options' => [
				'icons'              => esc_html__( 'Icons', 'medizin' ),
				'large-icons'        => esc_html__( 'Large Icons', 'medizin' ),
				'flat-rounded-icon'  => esc_html__( 'Flat Rounded Icon', 'medizin' ),
				'solid-rounded-icon' => esc_html__( 'Solid Rounded Icon', 'medizin' ),
				'icon-title'         => esc_html__( 'Icon + Title', 'medizin' ),
		...
		$this->add_control( 'layout', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'inline'      => esc_html__( 'Inline', 'medizin' ),
				'list'        => esc_html__( 'List', 'medizin' ),
				'two-columns' => esc_html__( '2 Columns', 'medizin' ),
			],
			'default' => 'inline',
		] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				...
				[
					'title' => esc_html__( 'Linkedin', 'medizin' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
