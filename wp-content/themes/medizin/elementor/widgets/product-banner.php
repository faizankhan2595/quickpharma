...
class Widget_Product_Banner extends Base {
	...
	public function get_title() {
		return esc_html__( 'Product Banner', 'medizin' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'product_id', [
			'label'        => esc_html__( 'Choose Product', 'medizin' ),
		...
		$this->add_control( 'show_sale_badge', [
			'label' => esc_html__( 'Show Sale Badge', 'medizin' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'show_best_selling_badge', [
			'label' => esc_html__( 'Show Best Selling Badge', 'medizin' ),
			'type'  => Controls_Manager::SWITCHER,
		] );
		...
		$this->add_control( 'sub_text', [
			'label'   => esc_html__( 'Sub text', 'medizin' ),
			'type'        => Controls_Manager::TEXT,
			'dynamic'     => [
				'active' => true,
			],
			'placeholder' => esc_html__( 'Enter your sub text', 'medizin' ),
			'label_block' => true,
			'condition' => [
				'style' => '02',
			],
	...
	private function add_box_style_section() {
		...
		$this->add_responsive_control( 'box_height', [
			...
			'selectors'  => [
				'{{WRAPPER}} .medizin-box' => 'height: {{SIZE}}{{UNIT}};',
			],
		] );
	...
	private function add_content_style_section() {
		...
		$this->add_responsive_control( 'image_height', [
			...
			'selectors'  => [
				'{{WRAPPER}} .medizin-box .medizin-image' => 'height: {{SIZE}}{{UNIT}};',
			],
		] );
	...
	private function add_badge_style_section() {
		...
		$this->add_control( 'badge_value_style_heading', [
			'label'     => esc_html__( 'Value', 'medizin' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );

		$this->add_control( 'badge_value_color', [
			'label'     => esc_html__( 'Value Color', 'medizin' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'medizin-product-banner medizin-box link-secret style-' . $settings['style'] );
		?>
		...
		<?php if ( ! empty( $settings['show_best_selling_badge'] ) && 'yes' === $settings['show_best_selling_badge'] ) : ?>
			<div class="product-banner-badge best-selling-badge">
				<span class="badge-value"><?php esc_html_e( 'Best', 'medizin' ); ?></span><span
					class="badge-text"><?php esc_html_e( 'Selling', 'medizin' ); ?></span>
			</div>
		<?php endif; ?>
