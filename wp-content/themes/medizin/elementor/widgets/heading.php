...
class Widget_Heading extends Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Heading', 'medizin' );
	}
	...
	private function add_title_section() {
		$this->start_controls_section( 'title_section', [
			'label' => esc_html__( 'Heading', 'medizin' ),
		] );
		...
		$this->add_control( 'title', [
			...
			'description' => esc_html__( 'Wrap any words with &lt;mark&gt;&lt;/mark&gt; tag to make them highlight.', 'medizin' ),
		] );
		...
		$this->add_control( 'title_link_animate', [
			'label'        => esc_html__( 'Link Animate', 'medizin' ),
			'type'         => Controls_Manager::SELECT,
			'options'      => [
				''                  => esc_html__( 'None', 'medizin' ),
				'animate-border'    => esc_html__( 'Animate Border', 'medizin' ),
				'animate-border-02' => esc_html__( 'Animate Border 02', 'medizin' ),
			],
			'default'      => '',
			'prefix_class' => 'medizin-link-',
		] );
	...
	private function add_sub_title_section() {
		$this->start_controls_section( 'sub_title_section', [
			'label' => esc_html__( 'Secondary Heading', 'medizin' ),
		] );
	...
	private function add_title_style_section() {
		...
		$this->add_control( 'blend_mode', [
			'label'     => esc_html__( 'Blend Mode', 'medizin' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
		...
		$this->add_control( 'highlight_heading', [
			'label'     => esc_html__( 'Highlight Words', 'medizin' ),
	...
	private function add_divider_style_section() {
		$this->start_controls_section( 'divider_style_section', [
			'label'     => esc_html__( 'Divider', 'medizin' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'divider_enable' => 'yes',
			],
