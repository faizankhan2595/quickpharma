...
class Widget_Separator extends Base {
	...
	public function get_title() {
		return esc_html__( 'Separator', 'medizin' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'style', [
			...
			'options' => [
				'vertical-line'   => esc_html__( 'Vertical Line', 'medizin' ),
				'horizontal-line' => esc_html__( 'Horizontal Line', 'medizin' ),
			],
			'default' => 'vertical-line',
		] );

		$this->add_control( 'play_animate', [
			'label'        => esc_html__( 'Play Animate', 'medizin' ),
