...
class Widget_Gallery_Justified_Content extends Base {
	...
	public function get_title() {
		return esc_html__( 'Gallery Justified Content', 'medizin' );
	}
	...
	public function get_script_depends() {
		return [ 'medizin-widget-gallery-justified-content' ];
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'medizin-gallery-justified-content' );
		?>
