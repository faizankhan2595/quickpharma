...
class Widget_Mailchimp_Form extends Form_Base {
	...
	public function get_title() {
		return esc_html__( 'Mailchimp Form', 'medizin' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'form_id', [
			'label'       => esc_html__( 'Form Id', 'medizin' ),
			'description' => esc_html__( 'Input the id of form. Leave blank to show default form.', 'medizin' ),
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'medizin-mailchimp-form-style-',
		] );
	...
	protected function render() {
		...
		$this->add_render_attribute( 'box', 'class', 'medizin-mailchimp-form' );
		?>
