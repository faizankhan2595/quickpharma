...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '2.8.1' );
			...
			class WPCleverWoosw {
				...
				function wishlist_add() {
					...
					if ( ( $product_id = absint( $_POST['product_id'] ) ) > 0 ) {
						...
						if ( $key === '#' ) {
							$return['status'] = 0;
							$return['notice'] = esc_html__( 'Please log in to use the wishlist!', 'woo-smart-wishlist' );
							...
							if ( ! array_key_exists( $product_id, $products ) ) {
								...
								$return['notice'] = esc_html__( 'Added to the wishlist!', 'woo-smart-wishlist' );
								$return['image']  = WOOSW_URI . 'assets/images/heart_add.svg';
							} else {
								$return['notice'] = esc_html__( 'Already in the wishlist!', 'woo-smart-wishlist' );
				...
				function wishlist_load() {
					...
					if ( $key === '#' ) {
						$return['notice'] = esc_html__( 'Please log in to use wishlist!', 'woo-smart-wishlist' );
					} else {
						$products = array();
				...
				function shortcode( $atts ) {
					...
					if ( $atts['id'] ) {
						...
						if ( array_key_exists( $atts['id'], self::$added_products ) ) {
							...
							if ( empty( $text ) ) {
								$text = esc_html__( 'Browse wishlist', 'woo-smart-wishlist' );
							}
							...
							if ( empty( $text ) ) {
								$text = esc_html__( 'Add to wishlist', 'woo-smart-wishlist' );
							}
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
											...
											<?php esc_html_e( 'Auto remove product from the wishlist after adding to the cart.', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
											<?php esc_html_e( 'Show note on each product for all visitors. Only wishlist owner can add/edit these notes.', 'woo-smart-wishlist' ); ?>
										</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
											<?php printf( esc_html__( 'Add shortcode %s to display the wishlist on a page.', 'woo-smart-wishlist' ), '<code>[woosw_list]</code>' ); ?>
                                                    <br/>
													<?php esc_html_e( 'After choosing a page, please go to Setting >> Permalinks and press Save Changes.', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
                                                    <?php esc_html_e( 'Enable share buttons on the wishlist page?', 'woo-smart-wishlist' ); ?>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
                                                    <?php esc_html_e( 'Enable copy wishlist link to share?', 'woo-smart-wishlist' ); ?>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr class="heading">
                                        ...
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Text', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_button_text"
                                                       value="<?php echo get_option( 'woosw_button_text', '' ); ?>"
                                                       placeholder="<?php esc_html_e( 'Add to wishlist', 'woo-smart-wishlist' ); ?>"/>
                                                <span class="description">
													<?php esc_html_e( 'Leave blank to use the default text or its equivalent translation in multiple languages.', 'woo-smart-wishlist' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr>
											...
											<?php esc_html_e( 'Action triggered by clicking on the wishlist button.', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Text (added)', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_button_text_added"
                                                       value="<?php echo get_option( 'woosw_button_text_added', '' ); ?>"
                                                       placeholder="<?php esc_html_e( 'Browse wishlist', 'woo-smart-wishlist' ); ?>"/>
                                                <span class="description">
													<?php esc_html_e( 'Text shown after adding an item to the wishlist. Leave blank to use the default text or its equivalent translation in multiple languages.', 'woo-smart-wishlist' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr>
											...
											<?php esc_html_e( 'Action triggered by clicking on the wishlist button after adding an item to the wishlist.', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												?>
                                                <span class="description">
													<?php esc_html_e( 'Only show the wishlist button for products in selected categories.', 'woo-smart-wishlist' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr class="heading">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
											<?php printf( esc_html__( 'Choose the color, default %s', 'woo-smart-wishlist' ), '<code>' . $color_default . '</code>' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												?>
                                                <span class="description">
											<?php esc_html_e( 'Choose the menu(s) you want to add the "wishlist menu" at the end.', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
											...
											<?php esc_html_e( 'Action when clicking on the "wishlist menu".', 'woo-smart-wishlist' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr class="submit">
				...
				function wp_enqueue_scripts() {
					...
					if ( empty( $text_added ) ) {
						$text_added = esc_html__( 'Browse wishlist', 'woo-smart-wishlist' );
					}
					...
					wp_localize_script( 'woosw-frontend', 'woosw_vars', array(
							...
							'copied_text'         => esc_html__( 'Copied the wishlist link:', 'woo-smart-wishlist' ),
							'menu_text'           => esc_html__( 'Wishlist', 'woo-smart-wishlist' ),
				...
				function woosw_nav_menu_items( $items, $args ) {
					...
					if ( $selected ) {
						$items .= '<li class="menu-item woosw-menu-item menu-item-type-woosw"><a href="' . self::get_url() . '"><span class="woosw-menu-item-inner" data-count="' . self::get_count() . '">' . esc_html__( 'Wishlist', 'woo-smart-wishlist' ) . '</span></a></li>';
					}
