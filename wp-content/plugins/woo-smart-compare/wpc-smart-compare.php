...
! defined( 'WOOSC_VERSION' ) && define( 'WOOSC_VERSION', '4.0.2' );
		...
		if ( ! class_exists( 'WPCleverWoosc' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWoosc {
				...
				function woosc_wp_enqueue_scripts() {
					...
					// frontend css & js
					wp_enqueue_style( 'woosc-frontend', WOOSC_URI . 'assets/css/frontend.css' );
					wp_enqueue_script( 'woosc-frontend', WOOSC_URI . 'assets/js/frontend.js', array( 'jquery' ), WOOSC_VERSION, true );

					$woosc_limit_notice = get_option( 'woosc_limit_notice' );
					...
					$button_text       = get_option( 'woosc_button_text' );
					$button_text_added = get_option( 'woosc_button_text_added' );
					...
					wp_localize_script( 'woosc-frontend', 'woosc_vars', array(
							...
							'button_text'        => apply_filters( 'woosc_button_text', $button_text ),
							'button_text_added'  => apply_filters( 'woosc_button_text_added', $button_text_added ),
				...
				function woosc_admin_enqueue_scripts( $hook ) {
					wp_enqueue_style( 'woosc-backend', WOOSC_URI . 'assets/css/backend.css' );
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="woosc_limit_notice" type="text"
                                                       style="width: 100%; max-width: 600px"
                                                       class="regular-text"
                                                       value="<?php echo get_option( 'woosc_limit_notice' ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosc_open_button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosc_button_text"
                                                       value="<?php echo get_option( 'woosc_button_text' ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosc_button_text_added"
                                                       value="<?php echo get_option( 'woosc_button_text_added' ); ?>"
                                                       placeholder="<?php esc_html_e( 'Compare', 'woo-smart-compare' ); ?>"/>
                                                <span class="description">
													<?php esc_html_e( 'Leave blank if you want to use the default text and can be translated.', 'woo-smart-compare' ); ?>
												</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosc_button_class"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosc_bar_btn_text"
                                                       value="<?php echo get_option( 'woosc_bar_btn_text' ); ?>"
                                                       placeholder="<?php esc_html_e( 'Compare', 'woo-smart-compare' ); ?>"/>
                                                <span class="description">
													<?php esc_html_e( 'Leave blank if you want to use the default text and can be translated.', 'woo-smart-compare' ); ?>
												</span>
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
                                                ...
                                                <input type="hidden" name="page_options"
                                                       value="woosc_open_button,woosc_open_button_action,woosc_button_type,woosc_button_text,woosc_button_text_change,woosc_button_text_added,woosc_button_class,woosc_button_archive,woosc_button_single,woosc_open_bar_immediately,woosc_open_immediately,woosc_hide_checkout,woosc_click_again,woosc_close_button,woosc_hide_empty,woosc_bar_bubble,woosc_bar_settings,woosc_bar_add,woosc_bar_remove,woosc_bar_bg_color,woosc_bar_btn_text,woosc_bar_btn_color,woosc_bar_pos,woosc_bar_align,woosc_click_outside,woosc_limit,woosc_limit_notice,woosc_page_id,woosc_fields,woosc_attributes,woosc_custom_attributes,woosc_custom_fields,woosc_image_size,woosc_link,woosc_freeze_column,woosc_freeze_row,woosc_search_count,woosc_search_cats,woosc_menus,woosc_menu_action"/>
                                            </th>
                                        </tr>
                                    </table>
                                </form>
				...
				function woosc_get_bar() {
					...
					if ( ! empty( $woosc_products ) ) {
						foreach ( $woosc_products as $woosc_product ) {
							...
							$woosc_bar .= '<span class="woosc-bar-item-remove" data-id="' . $woosc_product_id . '"></span></div>';
						}
					}
				...
				function woosc_get_table( $ajax = true ) {
					...
					if ( is_array( $woosc_products ) && ( count( $woosc_products ) > 0 ) ) {
						...
						foreach ( $woosc_products as $woosc_product ) {
							...
							if ( $link !== 'no' ) {
								$woosc_products_data[ $woosc_product ]['name'] = apply_filters( 'woosc_product_name', '<a ' . ( $link === 'yes_popup' ? 'class="woosq-btn" data-id="' . $woosc_product . '"' : '' ) . ' href="' . $product->get_permalink() . '" draggable="false" ' . ( $link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . wp_strip_all_tags( $product_name ) . '</a>', $product );
							} else {
							...
							if ( in_array( 'image', $saved_fields, true ) ) {
								if ( $link !== 'no' ) {
									$woosc_products_data[ $woosc_product ]['image'] = apply_filters( 'woosc_product_image', '<a ' . ( $link === 'yes_popup' ? 'class="woosq-btn" data-id="' . $woosc_product . '"' : '' ) . ' href="' . $product->get_permalink() . '" draggable="false" ' . ( $link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . $product->get_image( get_option( 'woosc_image_size', 'woosc-large' ), array( 'draggable' => 'false' ) ) . '</a>', $product );
								} else {
						...
						$woosc_table = '<div class="woosc-no-result">' . esc_html__( 'No products in the compare table.', 'woo-smart-compare' ) . '</div>';
					}
				...
				function woosc_wp_footer() {
					...
					$woosc_bar_btn_color_default = apply_filters( 'woosc_bar_btn_color_default', '#00a0d2' );
					?>
					<?php if ( get_option( 'woosc_bar_add', 'yes' ) === 'yes' ) { ?>
					...
					<?php } ?>
					<?php if ( get_option( 'woosc_bar_settings', 'yes' ) === 'yes' ) { ?>
                        ...
                        <div class="woosc-inner">
                            ...
                            <div class="woosc-bar <?php echo esc_attr( get_option( 'woosc_bar_bubble', 'no' ) === 'yes' ? 'woosc-bar-bubble' : '' ); ?>">
                                ...
                                <div class="woosc-bar-btn woosc-bar-btn-text">
									...
									<?php
									$bar_btn_text = get_option( 'woosc_bar_btn_text' );

									if ( empty( $bar_btn_text ) ) {
										$bar_btn_text = esc_html__( 'Compare', 'woo-smart-compare' );
									}

									echo apply_filters( 'woosc_bar_btn_text', esc_html( $bar_btn_text ) );
									?>
                                </div>
                            </div>
                        </div>
				...
				function woosc_nav_menu_items( $items, $args ) {
					...
					if ( $selected ) {
						$items .= '<li class="menu-item woosc-menu-item menu-item-type-woosc"><a href="' . self::woosc_get_page_url() . '"><span class="woosc-menu-item-inner" data-count="' . $this->woosc_get_count() . '">' . esc_html__( 'Compare', 'woo-smart-compare' ) . '</span></a></li>';
					}
